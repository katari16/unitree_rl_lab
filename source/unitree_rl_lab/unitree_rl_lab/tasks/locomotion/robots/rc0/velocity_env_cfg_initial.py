...
from unitree_rl_lab.assets.robots.unitree import HUMANOIDV0_CFG as ROBOT_CFG
...
class RobotSceneCfg(InteractiveSceneCfg):
    """Configuration for the terrain scene with RC0 humanoid robot."""
...
class RewardsCfg:
    ...
    joint_deviation_waists = RewTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                "robot",
                joint_names=["hip_rotor", "hip_abductor0"],
            )
        },
    )
    joint_deviation_legs = RewTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                "robot",
                joint_names=[
                    "left_leg_abductor", "left_leg_rotor",
                    "right_leg_abductor", "right_leg_rotor"
                ]
            )
        },
    )
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the RC0 locomotion velocity-tracking environment."""
